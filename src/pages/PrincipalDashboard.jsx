  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">Review content status and approvals across the application.</p>
      </div>
      ...
      <section>
        ...
        {loading ? <LoadingSkeleton lines={6} /> : <ContentTable items={contents.slice(0, 10)} />}
      </section>
    </div>
  )
}
